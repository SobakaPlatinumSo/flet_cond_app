...
# api_id = 28504321
# api_hash = "462e0898fed73edb268e34bc72eb1dfd"

# app = pyrogram.Client("my_account", api_id=api_id, api_hash=api_hash)

# async def msg_send():
#     await app.start()
#     await app.send_message('Balistic168_bot', "/start")
#     await app.send_message('Balistic168_bot', "/1")
#     await app.stop()

# async def main(page):
#     async def button_clicked(e):
#         await msg_send()
#         await page.add_async(ft.Text("Clicked!"))

#     await page.add_async(ft.ElevatedButton(text="Update", on_click=button_clicked))
...
# logging.basicConfig(level=logging.INFO)
# # Объект бота
# bot = Bot(token="5601155526:AAE5QTrtt9Ibh8mWxdYstdT1EYjxw12k_hY")
# # Диспетчер
# dp = Dispatcher()
...
#     await message.answer("start has answered")
# @dp.message(Command("1"))
# async def cmd_start(message: types.Message):
#     await message.answer("1 has answered")
